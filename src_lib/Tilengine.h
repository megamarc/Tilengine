...
typedef struct Cycle*		 TLN_Cycle;
...
int LIBAPI TLN_GetWidth (void);
int LIBAPI TLN_GetHeight (void);
...
int LIBAPI TLN_GetBitmapWidth (TLN_Bitmap bitmap);
int LIBAPI TLN_GetBitmapHeight (TLN_Bitmap bitmap);
int LIBAPI TLN_GetBitmapPitch (TLN_Bitmap bitmap);
TLN_Palette LIBAPI TLN_GetBitmapPalette (TLN_Bitmap bitmap);
void LIBAPI TLN_SetBitmapPalette (TLN_Bitmap bitmap, TLN_Palette palette);
...
TLN_Cycle LIBAPI TLN_CreateCycle (char* name, int num_strips, TLN_ColorStrip* strips);
...
TLN_SequencePack LIBAPI TLN_CreateSequencePack (void);
...
void LIBAPI TLN_AddSequenceToPack (TLN_SequencePack sp, TLN_Sequence sequence);
