...
procedure SetLoadPath(path : string); cdecl; external dllname name 'TLN_SetLoadPath';
...
function GetErrorString : string; cdecl; external dllname name 'TLN_GetErrorString';

// Built-in windowing
procedure CreateWindow(overlay : string; flags : TWindowFlags); cdecl; external dllname name 'TLN_CreateWindow';
...
function ProcessWindow : Boolean ; cdecl; external dllname name 'TLN_ProcessWindow';
function IsWindowActive : Boolean ; cdecl; external dllname name 'TLN_IsWindowActive';
function GetInput(id : TInput) : Boolean ; cdecl; external dllname name 'TLN_GetInput';
...
procedure EnableBlur(mode : Boolean ); cdecl; external dllname name 'TLN_EnableBlur';
...
// Layer management
function SetLayer(nlayer : Integer; tileset, tilemap : Pointer) : Boolean ; cdecl; external dllname name 'TLN_SetLayer';
function SetLayerPalette(nlayer : Integer; palette : Pointer) : Boolean ; cdecl; external dllname name 'TLN_SetLayerPalette';
function SetLayerPosition(nlayer , hstart, vstart : Integer) : Boolean ; cdecl; external dllname name 'TLN_SetLayerPosition';
function SetLayerScaling(nlayer : Integer; xfactor, yfactor : Single) : Boolean ; cdecl; external dllname name 'TLN_SetLayerScaling';
function SetLayerAffineTransform(nlayer : Integer; affine : PAffine) : Boolean ; cdecl; external dllname name 'TLN_SetLayerAffineTransform';
function SetLayerTransform(layer : Integer; angle, dx, dy, sx, sy : Single) : Boolean ; cdecl; external dllname name 'TLN_SetLayerTransform';
...
function GetLayerTile(nlayer : Integer; x , y : Integer; info : PTileInfo ) : Boolean ; cdecl; external dllname name 'TLN_GetLayerTile';

// Sprite management
function ConfigSprite(nsprite : Integer; spriteset : Pointer; flags : TTileFlags) : Boolean ; cdecl; external dllname name 'TLN_ConfigSprite';
function SetSpriteSet(nsprite : Integer; spriteset : Pointer) : Boolean ; cdecl; external dllname name 'TLN_SetSpriteSet';
function SetSpriteFlags(nsprite : Integer; flags : TTileFlags) : Boolean ; cdecl; external dllname name 'TLN_SetSpriteFlags';
function SetSpritePosition(nsprite, x, y : Integer) : Boolean ; cdecl; external dllname name 'TLN_SetSpritePosition';
function SetSpritePicture(nsprite, entry : Integer) : Boolean ; cdecl; external dllname name 'TLN_SetSpritePicture';
function SetSpritePalette(nsprite : Integer; palette : PInteger) : Boolean ; cdecl; external dllname name 'TLN_SetSpritePalette';
function SetSpriteBlendMode(nsprite : Integer; mode : TBlend; factor : Byte) : Boolean ; cdecl; external dllname name 'TLN_SetSpriteBlendMode';
function SetSpriteScaling(nsprite : Integer; sx, sy : Single) : Boolean ; cdecl; external dllname name 'TLN_SetSpriteScaling';
function ResetSpriteScaling(nsprite : Integer) : Boolean ; cdecl; external dllname name 'TLN_ResetSpriteScaling';
...
function EnableSpriteCollision(nsprite : Integer; enable : Boolean ) : Boolean ; cdecl; external dllname name 'TLN_EnableSpriteCollision';
function GetSpriteCollision(nsprite : Integer) : Boolean ; cdecl; external dllname name 'TLN_GetSpriteCollision';
function DisableSprite(nsprite : Integer) : Boolean ; cdecl; external dllname name 'TLN_DisableSprite';
function GetSpritePalette(nsprite : Integer) : Pointer; cdecl; external dllname name 'TLN_GetSpritePalette';

// Animation management
function SetPaletteAnimation(index : Integer; palette : Pointer; sequence : Pointer; blend : Boolean ) : Boolean ; cdecl; external dllname name 'TLN_SetPaletteAnimation';
function SetPaletteAnimationSource(index : Integer; palette : Pointer) : Boolean ; cdecl; external dllname name 'TLN_SetPaletteAnimationSource';
function SetTilesetAnimation(index, nlayer : Integer; sequence : Pointer) : Boolean ; cdecl; external dllname name 'TLN_SetTilesetAnimation';
function SetTilemapAnimation(index, nlayer : Integer; sequence : Pointer) : Boolean ; cdecl; external dllname name 'TLN_SetTilemapAnimation';
function SetSpriteAnimation(index, nsprite : Integer; sequence : Pointer; loop : Integer) : Boolean ; cdecl; external dllname name 'TLN_SetSpriteAnimation';
function GetAnimationState(index : Integer) : Boolean ; cdecl; external dllname name 'TLN_GetAnimationState';
function SetAnimationDelay(index : Integer; delay : Integer) : Boolean ; cdecl; external dllname name 'TLN_SetAnimationDelay';
function GetAvailableAnimation : Integer; cdecl; external dllname name 'TLN_GetAvailableAnimation';
function DisableAnimation(index : Integer) : Boolean ; cdecl; external dllname name 'TLN_DisableAnimation';
...
function GetSpriteInfo(spriteset : Pointer; entry : Integer; info : PSpriteInfo) : Boolean ; cdecl; external dllname name 'TLN_GetSpriteInfo';
function GetSpritesetPalette(spriteset : Pointer) : Pointer; cdecl; external dllname name 'TLN_GetSpritesetPalette';
function DeleteSpriteset(spriteset : Pointer) : Boolean ; cdecl; external dllname name 'TLN_DeleteSpriteset';
...
function DeleteTileset(tileset : Pointer) : Boolean ; cdecl; external dllname name 'TLN_DeleteTileset';
...
function GetTilemapTile(tilemap : Pointer; row, col : Integer; tile : PTile) : Boolean ; cdecl; external dllname name 'TLN_GetTilemapTile';
function SetTilemapTile(tilemap : Pointer; row, col : Integer; tile : PTile) : Boolean ; cdecl; external dllname name 'TLN_SetTilemapTile';
function CopyTiles(src : Pointer; srcrow, srccol, rows, cols : Integer; dst : Pointer; dstrow, dstcol : Integer) : Boolean ; cdecl; external dllname name 'TLN_CopyTiles';
function DeleteTilemap(tilemap : Pointer) : Boolean ; Register; external dllname name 'TLN_DeleteTilemap';
...
function SetPaletteColor(palette : Pointer; color : Integer; r, g, b : Byte) : Boolean ; cdecl; external dllname name 'TLN_SetPaletteColor';
function MixPalettes(src1, src2, dest : Pointer; factor : Byte) : Boolean ; cdecl; external dllname name 'TLN_MixPalettes';
function GetPaletteData(palette : Pointer; index : Integer) : Pointer; cdecl; external dllname name 'TLN_GetPaletteData';
function DeletePalette(palette : Pointer) : Boolean ; cdecl; external dllname name 'TLN_DeletePalette';
...
function SetBitmapPalette(bitmap, palette : Pointer) : Boolean ; cdecl; external dllname name 'TLN_SetBitmapPalette';
function DeleteBitmap(bitmap : Pointer) : Boolean ; cdecl; external dllname name 'TLN_DeleteBitmap';
...
function DeleteSequence(sequence : Pointer) : Boolean ; cdecl; external dllname name 'TLN_DeleteSequence';
...
function AddSequenceToPack(sp, sequence : Pointer) : Boolean ; cdecl; external dllname name 'TLN_AddSequenceToPack';
function DeleteSequencePack(sp : Pointer) : Boolean ; cdecl; external dllname name 'TLN_DeleteSequencePack';
